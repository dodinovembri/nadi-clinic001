        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Edit Slider</h1>
                    <ul>
                        <li><a href="<?= base_url($trial_name . '/extranet/laboratory_feature') ?>">Slider</a></li>
                        <li>Edit Slider</li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="<?= base_url($trial_name . '/extranet/laboratory_feature/update/' . $laboratory_feature->id) ?>" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="margin-top: 20px;">
                                            ...
                                            <a href="<?= base_url($trial_name . '/extranet/laboratory_feature') ?>"><button type="button" class="btn btn-warning">Cancel</button></a>
                                        </div>
                                    </div>
                                </form>
                            </div>
