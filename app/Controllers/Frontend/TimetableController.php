...
class TimetableController extends BaseController
{
    public function index($trial_name = null)
    {
        ...
        $data['department_timetables'] = $department_timetable->where('department_id', $first_department->id)->where('client_id', $client_id)->where('status', 1)->get()->getResult();
    ...
    public function show($trial_name = null, $id)
    {
        ...
        // department timetable
        $department_timetable = new DepartmentTimetableModel();
        $data['department_timetables'] = $department_timetable->where('department_id', $id)->where('client_id', $client_id)->where('status', 1)->get()->getResult();
        $data['department'] = $department->where('id', $id)->where('client_id', $client_id)->where('status', 1)->get()->getFirstRow();
